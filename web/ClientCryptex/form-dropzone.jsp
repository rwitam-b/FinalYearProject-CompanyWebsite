    ...
    <div id="wrapper">
     ...
     <div class="navbar-default sidebar" role="navigation">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Upload Files</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <button class="right-side-toggle waves-effect waves-light btn-info btn-circle pull-right m-l-20"><i class="ti-settings text-white"></i></button>
                        <a href="index_citrix.html" target="_self" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Back to Vault</a>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2017 &copy; Ample Admin | Cryptex
